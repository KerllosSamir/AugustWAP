...
const w2d3FunctionConstructor = (function () {
    ...
    Person.prototype.favoriteHobby = function () {
        return "My name is " + this.name + " and my hobby is " + this.hoppy;
    }
...
const w2d3ES6 = (function () {
    ...
    class Teacher extends Person {
        constructor(name, age, hoppy, subject) {
            super(name, age, hoppy);
            this.subject = subject;
        }
